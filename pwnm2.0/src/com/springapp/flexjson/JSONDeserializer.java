...
import com.springapp.flexjson.factories.ClassLocatorObjectFactory;
import com.springapp.flexjson.factories.ExistingObjectFactory;
import com.springapp.flexjson.locators.StaticClassLocator;
 ...
 * To do that we'll use the {@link com.springapp.flexjson.JSONDeserializer#use(String, Class)} method like so:
 * </p>
 * <pre>
 ...
 * the Hero class to the root of the json.  The {@link com.springapp.flexjson.JSONDeserializer#use(String, Class)} method  uses
 ...
 * </p>
 * <p>
 * Before we showed how the {@link com.springapp.flexjson.JSONDeserializer#use(String, Class)} method would allow us to
 ...
 * possibilities.  That's where the second version of {@link com.springapp.flexjson.JSONDeserializer#use(String, ClassLocator)}
 * comes into play.  {@link com.springapp.flexjson.ClassLocator} allow you to use a stradegy for finding which java Class
 * you want to attach at a particular object path.
 * </p>
 * <p>
 * {@link com.springapp.flexjson.JSONDeserializer#use(String, ClassLocator)} have access to the intermediate form of
 ...
 * the {@link com.springapp.flexjson.JSONSerializer}.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Now onto the advanced topics of the deserializer.  {@link com.springapp.flexjson.ObjectFactory} interface is the
 ...
 * {@link com.springapp.flexjson.transformer.DateTransformer} to deserialize dates into Date objects.
 * </p>
 */
