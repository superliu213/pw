...
public interface ObjectFactory {
     ...
     * the object should be fully constructed.  {@link com.springapp.flexjson.ObjectBinder} can be used to bind values into
     * the object according to default rules.  For simple implementations you won't need to use this, but
     * for more complex or generic objects reusing methods like {@link com.springapp.flexjson.ObjectBinder#bind(Object, java.lang.reflect.Type)}
     * and {@link com.springapp.flexjson.ObjectBinder#bindIntoCollection(java.util.Collection, java.util.Collection, java.lang.reflect.Type)}.
     *
